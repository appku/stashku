...
describe('#isPlural', function () {
    BASIC_TESTS.concat(PLURAL_TESTS).forEach(function (test) {
        it('identifies ' + test[1] + ' as plural.)', function () {
